...
if [ ! -f ".env" ]; then
    echo "⚠️  No .env file found. Please create one with: nano .env"
    echo "Add: VITE_API_URL=http://your-server-ip"
    exit 1
fi
...
echo "✅ Deployment successful! Visit http://$(curl -s ifconfig.me)"
